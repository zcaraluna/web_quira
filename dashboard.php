...
<body>
    ...
    <script>
        ...
        function exportarPostulantes() {
            // Función para exportar postulantes (implementar según necesidades)
            alert('Función de exportación en desarrollo. Por ahora, puedes usar la función de copiar tabla del navegador.');
        }
                                        ...
                                        new docx.TableCell({
                                            children: [
                                                new docx.Paragraph({
                                                    children: [
                                                        new docx.TextRun({
                                                            text: "<?= html_entity_decode($unidad['unidad'], ENT_QUOTES, 'UTF-8') ?>",
                                                            size: 20
                                                        })
                                                    ]
                                                })
                                        ...
                                        new docx.TableCell({
                                            children: [
                                                new docx.Paragraph({
                                                    children: [
                                                        new docx.TextRun({
                                                            text: "UNIDAD: <?= html_entity_decode($unidad, ENT_QUOTES, 'UTF-8') ?>",
                                                            bold: true,
                                                            size: 22,
                                                            color: "2E5090"
                                                        })
